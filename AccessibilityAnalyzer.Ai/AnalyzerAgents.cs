...
public static class AnalyzerAgents
{
    ...
    public static ChatCompletionAgent AltTextAnalyzerAgent(Kernel kernel, string code) => new()
    {
        ...
        Instructions =
            ...
            3. Properly Descriptive Alt Text
               ...
               - Alt text cannot be empty, just alt or alt = "" is not correct
    ...
    public static ChatCompletionAgent KeyboardNavigationAgent(Kernel kernel, string code) => new()
    {
    ...
    public static ChatCompletionAgent FormValidationAgent(Kernel kernel, string code) => new()
    {
    ...
    public static ChatCompletionAgent SemanticCodeAgent(Kernel kernel, string code) => new()
    {
